...
{
    public partial class frmSelectRemoteProjectPostBuild : Form, ISelect<SelectRemoteProjectOutputPostBuild>
    {
        private SelectRemoteProjectOutputPostBuild m_SelectResult;
        public SelectRemoteProjectOutputPostBuild SelectResult => m_SelectResult;
        ...
        public frmSelectRemoteProjectPostBuild(ILogNotify logNotify, ICommandNotify commandNotify)
        {
            InitializeComponent();
            LogNotify = logNotify;
        ...
        {
            m_SelectResult = new SelectRemoteProjectOutputPostBuild(cmbProject.SelectedItem, cmbBranch.SelectedItem, this.txtTag.Text, cmdLocalBuildFolder.SelectedItem, input.GenerateWaitGetTagFunc(cmbBranch.SelectedItem.ToString()));
