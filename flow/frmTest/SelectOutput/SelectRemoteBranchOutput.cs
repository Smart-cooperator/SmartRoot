...
{
    public class SelectRemoteBranchOutput
    {
        ...
        public SelectRemoteBranchOutput(object selectProject, object selectRemoteBranch, string tag, string lastModifiedTime, string newBranchName)
        {
            ...
            m_NewBranchName = newBranchName;
        }
        public SelectRemoteBranchOutput()
        {
